...
public class Student 
{
    ...
    public int[] getAsgnGrades()
        throws NotPassedInException, NoSuchAssignmentException
    {
        ...
        throws NotPassedInException, NoSuchAssignmentException
    {
        if(numPassedIn == 0)
        {
            throw new NotPassedInException("A"+ asgn + " has not been passed in.");            
        }
    ...
    public int getPctGrade()
        throws NoBasisForEvaluationException 
    {
        if(numPassedIn == 0)
        {
            throw new NoBasisForEvaluationException();
        }
    ...
    public String getLetterGrade()
        throws NoSuchAssignmentException, NoBasisForEvaluationException
    {      
    ...
    public void setAsgnGrade(int asgn, int grade)
        throws InvalidGradeException,NoSuchAssignmentException
    {
        if(!validAsgnNumber(asgn))
        {
            throw new NoSuchAssignmentException("There is no A"+ asgn);
        }
    ...
    public void printRecord()
        throws NoBasisForEvaluationException, NoSuchAssignmentException 
    {
        System.out.print("\n"
           + "\nStudent #: \t" + getANumber()
           + "\nName:      \t" + name
